...
const heightInDecimal = binaryToDecimal(data.height);
const weightInDecimal = binaryToDecimal(data.weight);
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="full-screen-window p-6 rounded-lg shadow-lg w-80 text-white">
        ...
        <p>Height: {heightInDecimal}</p>
        <p>Weight: {weightInDecimal}</p>
        <div className="mt-4">
          <button
