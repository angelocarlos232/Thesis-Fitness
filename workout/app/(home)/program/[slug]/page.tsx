...
import FatBurnWorkout from '@/utils/caulculators/fat_workout';
  ...
  return (
    <div className="px-6 xl:w-3/4 mx-auto py-10 flex flex-col gap-20 text-md">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>
            ...
            {data.overview.weight > ideal_weight
              && ` lose ${data.overview.weight - ideal_weight
              } Kg to reach the ideal weight suggested (${ideal_weight} kg), `}
            {data.overview.weight < ideal_weight
              && ` gain ${ideal_weight - data.overview.weight
              } Kg to reach the ideal weight suggested (${ideal_weight} kg), `}
            {data.overview.weight === ideal_weight
              && ' maintain your current weight, '}
            and for the body composition you should
            {composition.fat_percentage > composition.ideal_fat
              && ` burn ${composition.fat_percentage - composition.ideal_fat
              } % of body fat to reach the ideal body composition suggested (${composition.ideal_fat
              } %).`}
            {composition.fat_percentage <= composition.ideal_fat
      ...
      {data.overview.fitness_goal === 'burn_fats' && (
        <FatBurnWorkout workout_days={data.overview.workout_days} />
      )}
