...
import getFatBurnWorkout, { WorkoutProgram, Exercise } from '@/utils/caulculators/fatburn';

export default function FatBurnWorkout({
  workout_days,
}: {
  workout_days: number;
}) {
  const workoutProgram: WorkoutProgram[] = getFatBurnWorkout(workout_days);
